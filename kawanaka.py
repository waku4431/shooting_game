...
#Enemy
enemyImg = pygame.image.load('kimo.png')
...
while running:#スクリーンを閉じずに開いている
    ...
    message=font.render('Welcome to kawanaka shooting!',False,(255,255,255))
    ...
    if enemyX <= 0: #左端に来たら
        enemyX_change = random.randint(1,6)
        enemyY += enemyY_change
    elif enemyX >=736: #右端に来たら
        enemyX_change = random.randint(-6,-1)
        enemyY += enemyY_change
